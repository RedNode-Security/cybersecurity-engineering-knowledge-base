---
title: Azure High-Risk App Consent
domain: blue-team
...
# Azure High-Risk App Consent

## Detection ID

```text
DET-CLOUD-AZURE_HIGH_RISK_APP_CONSENT
```
...
High-risk OAuth consent may expose mail, files, or directory data.
...
```text
app consent high_risk_scopes and unverified publisher
```
...
Consent is identity and application risk at the same time.
...
```text
TEST-DET-CLOUD-AZURE_HIGH_RISK_APP_CONSENT
```
