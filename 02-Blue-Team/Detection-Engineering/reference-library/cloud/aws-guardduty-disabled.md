...
```text
DET-CLOUD-AWS_GUARDDUTY_DISABLED
```
...
Cloud defense impairment may involve disabling GuardDuty.
...
```text
GuardDuty disable/delete events by unexpected actor
```
...
```json
{
  "event_id": "evt-cloud-005",
  "eventName": "DeleteDetector",
  "actor": "unexpected-role"
}
```
...
Confirm whether findings stopped after the change.
...
```text
TEST-DET-CLOUD-AWS_GUARDDUTY_DISABLED
```
