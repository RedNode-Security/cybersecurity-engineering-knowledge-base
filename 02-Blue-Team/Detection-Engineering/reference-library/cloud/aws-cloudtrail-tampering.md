---
title: AWS CloudTrail Logging Tampering
domain: blue-team
...
# AWS CloudTrail Logging Tampering

## Detection ID

```text
DET-CLOUD-AWS_CLOUDTRAIL_TAMPERING
```
...
Actors may modify logging to reduce visibility.
...
```text
eventName in StopLogging DeleteTrail PutEventSelectors and actor not logging_admin
```
...
```json
{
  "event_id": "evt-cloud-003",
  "eventName": "StopLogging",
  "actor": "arn:aws:iam::123:user/user"
}
```
...
```json
{
  "event_id": "evt-cloud-benign-003",
  "eventName": "UpdateTrail",
  "actor": "logging-pipeline-role",
  "change_id": "CHG-11"
}
```
...
Logging tampering is high priority because it affects every later question.
...
```text
TEST-DET-CLOUD-AWS_CLOUDTRAIL_TAMPERING
```
