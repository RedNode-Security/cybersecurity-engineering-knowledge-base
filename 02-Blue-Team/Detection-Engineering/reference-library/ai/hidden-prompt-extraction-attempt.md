---
title: Hidden Prompt Extraction Attempt
domain: blue-team
...
# Hidden Prompt Extraction Attempt

## Detection ID

```text
DET-AI-HIDDEN_PROMPT_EXTRACTION_ATTEMPT
```
...
Users may attempt to reveal hidden system or developer instructions.
...
```text
hidden_policy_request count by user > threshold
```
...
```json
{
  ...
  "prompt_category": "hidden_policy_request",
  "policy_result": "refused"
}
```
...
```json
{
  "event_id": "evt-ai-benign-005",
  "user": "developer@example.com",
  "prompt_category": "debug_prompt_view",
  "approved_debug": true
}
```
...
A refused attempt is still useful telemetry.
...
```text
TEST-DET-AI-HIDDEN_PROMPT_EXTRACTION_ATTEMPT
```
