---
title: LLM Tool Call Without Required Approval
domain: blue-team
...
# LLM Tool Call Without Required Approval

## Detection ID

```text
DET-AI-LLM_TOOL_CALL_WITHOUT_APPROVAL
```
...
Agent misuse may involve high-risk tool calls without approval.
...
```text
tool risk high and approval missing
```
...
The policy engine should catch this before the tool executes.
...
```text
TEST-DET-AI-LLM_TOOL_CALL_WITHOUT_APPROVAL
```
