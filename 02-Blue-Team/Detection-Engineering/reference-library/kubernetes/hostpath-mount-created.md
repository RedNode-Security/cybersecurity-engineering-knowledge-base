---
title: Kubernetes HostPath Mount Created
domain: blue-team
...
# Kubernetes HostPath Mount Created

## Detection ID

```text
DET-KUBERNETES-HOSTPATH_MOUNT_CREATED
```
...
HostPath mounts can expose node filesystem access.
...
```text
pod created with hostPath outside approved namespaces
```
...
Review path, service account, and image provenance.
...
```text
TEST-DET-KUBERNETES-HOSTPATH_MOUNT_CREATED
```
