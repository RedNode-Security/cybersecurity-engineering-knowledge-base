---
title: Kubernetes Exec in Sensitive Namespace
domain: blue-team
...
# Kubernetes Exec in Sensitive Namespace

## Detection ID

```text
DET-KUBERNETES-POD_EXEC_SENSITIVE_NAMESPACE
```
...
Interactive exec into sensitive pods may require review.
...
```text
pods/exec in sensitive namespace without ticket
```
...
Exec is often a human action. Ticket context matters.
...
```text
TEST-DET-KUBERNETES-POD_EXEC_SENSITIVE_NAMESPACE
```
