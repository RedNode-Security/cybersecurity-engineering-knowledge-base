...
```text
DET-WINDOWS-SECURITY_TOOL_SERVICE_STOPPED
```
...
Defense impairment may involve stopping security services.
...
```text
security_service stopped and not maintenance
```
...
```json
{
  "event_id": "evt-win-009",
  "host": "ws01",
  "service_name": "ExampleEDR",
  "action": "stopped",
  "actor": "EXAMPLE\\user"
}
```
...
Check whether the service restarted. A stop without restart is more concerning.
...
```text
TEST-DET-WINDOWS-SECURITY_TOOL_SERVICE_STOPPED
```
