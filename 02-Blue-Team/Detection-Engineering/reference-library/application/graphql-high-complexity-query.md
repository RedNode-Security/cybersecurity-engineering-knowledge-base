---
title: GraphQL High Complexity Query
domain: blue-team
...
# GraphQL High Complexity Query

## Detection ID

```text
DET-APPLICATION-GRAPHQL_HIGH_COMPLEXITY_QUERY
```
...
GraphQL abuse may involve high-complexity queries.
...
```text
graphql complexity > threshold and actor not approved
```
...
```json
{
  "event_id": "evt-app-004",
  "actor": "user@example.com",
  "operation": "NestedInvoiceQuery",
  "complexity": 9000,
  "limit": 1000
}
```
...
```json
{
  "event_id": "evt-app-benign-004",
  "actor": "internal-report",
  "operation": "MonthlyReport",
  "complexity": 8000,
  "approved_client": true
}
```
...
Complexity limits should be enforced, not only detected.
...
```text
TEST-DET-APPLICATION-GRAPHQL_HIGH_COMPLEXITY_QUERY
```
