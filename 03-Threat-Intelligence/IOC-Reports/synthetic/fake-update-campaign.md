---
title: IOC Report — Synthetic Fake Update Campaign
...
# IOC Report — Synthetic Fake Update Campaign

## Summary

Demonstrates indicator handling for a fake software update scenario.
...
|---|---|---|---|
| domain | `training-fake-update-campaign.example.invalid` | low | Synthetic domain |
