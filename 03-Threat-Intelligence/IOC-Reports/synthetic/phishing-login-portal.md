---
title: IOC Report — Synthetic Phishing Login Portal
...
# IOC Report — Synthetic Phishing Login Portal

## Summary

Demonstrates how to document a phishing-style indicator set.
...
|---|---|---|---|
| domain | `training-phishing-login-portal.example.invalid` | low | Synthetic domain |
