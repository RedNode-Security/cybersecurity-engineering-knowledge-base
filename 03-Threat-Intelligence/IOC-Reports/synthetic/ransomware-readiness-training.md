---
title: IOC Report — Synthetic Ransomware Readiness
...
# IOC Report — Synthetic Ransomware Readiness

## Summary

Demonstrates ransomware readiness indicator handling.
...
|---|---|---|---|
| domain | `training-ransomware-readiness-training.example.invalid` | low | Synthetic domain |
