---
title: IOC Report — Synthetic DNS Beacon Training
...
# IOC Report — Synthetic DNS Beacon Training

## Summary

Demonstrates DNS-focused enrichment and expiration.
...
|---|---|---|---|
| domain | `training-dns-beacon-training.example.invalid` | low | Synthetic domain |
