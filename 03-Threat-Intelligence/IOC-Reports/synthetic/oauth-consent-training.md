---
title: IOC Report — Synthetic OAuth Consent Abuse
...
# IOC Report — Synthetic OAuth Consent Abuse

## Summary

Demonstrates identity and OAuth-related indicator context.
...
|---|---|---|---|
| domain | `training-oauth-consent-training.example.invalid` | low | Synthetic domain |
