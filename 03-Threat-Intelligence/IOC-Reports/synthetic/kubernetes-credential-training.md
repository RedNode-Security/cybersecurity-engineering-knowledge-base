---
title: IOC Report — Synthetic Kubernetes Credential Access
...
# IOC Report — Synthetic Kubernetes Credential Access

## Summary

Demonstrates Kubernetes investigation indicator context.
...
|---|---|---|---|
| domain | `training-kubernetes-credential-training.example.invalid` | low | Synthetic domain |
