---
title: IOC Report — Synthetic LLM Prompt Injection Signals
...
# IOC Report — Synthetic LLM Prompt Injection Signals

## Summary

Demonstrates AI-security signal documentation.
...
|---|---|---|---|
| domain | `training-llm-injection-training.example.invalid` | low | Synthetic domain |
